...
const I18N_STRINGS = {
  en: {
    ...
    'issue.add.linkedPRs': 'Linked PRs (optional)',
    'issue.add.linkedPRsPlaceholder': 'e.g. 14, 15',
    ...
    'issue.detail.newSubIssue': 'New Sub-issue',
    'issue.detail.linkSubIssue': 'Link Sub-issue',
    ...
    'time.dayAgo': '{n}d ago',
    'issue.card.updated': 'Updated',
    'issue.card.closed': 'Closed',
...
> - The \`<!-- pm-meta -->\` comment at the end stores the linked branch; do not delete it manually`
  ...
  'zh-TW': {
    ...
    'issue.add.linkedPRs': '連結的 PR（選填）',
    'issue.add.linkedPRsPlaceholder': '例如 14, 15',
    ...
    'issue.detail.newSubIssue': '新增子任務',
    'issue.detail.linkSubIssue': '連結子任務',
    ...
    'time.justNow': '剛剛',
    'time.minAgo': '{n} 分鐘前',
    'issue.card.updated': '更新',
    'issue.card.closed': '關閉',
    'time.hourAgo': '{n} 小時前',
    'time.dayAgo': '{n} 天前',
    'state.loading': '載入中...',
    'state.syncing': '同步中...',
...
> - body 結尾的 \`<!-- pm-meta -->\` 為 branch 連結，請勿手動刪除`
  ...
  ja: {
    ...
    'issue.add.linkedPRs': 'リンクされたPR（任意）',
    'issue.add.linkedPRsPlaceholder': '例：14, 15',
    ...
    'issue.detail.newSubIssue': 'サブIssueを作成',
    'issue.detail.linkSubIssue': 'サブIssueをリンク',
